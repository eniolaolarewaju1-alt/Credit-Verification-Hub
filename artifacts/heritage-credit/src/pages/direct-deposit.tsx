...
export default function DirectDeposit() {
  ...
  const BANK_ROUTING = "253278401"; // Heritage CU routing number (Charleston SC)
            ...
            {isLoadingAccounts ? (
              ...
              <>
                ...
                <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-xl">
                  ...
                  <p className="text-xs text-blue-700">Contact support at (843) 555-0100 to get your full account number if needed.</p>
                </div>
              </>
            ) : (
