  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button className="bg-[#1A5C38] hover:bg-[#155A2F]">Add Payee</Button>
      </div>
              ...
              >
                ...
                <div className="flex items-center gap-6 w-full md:w-auto border-t md:border-t-0 pt-4 md:pt-0">
                  ...
                  <Button
                    ...
                    className="bg-[#1A5C38] hover:bg-[#155A2F]"
        ...
        <DialogContent className="sm:max-w-[420px]">
          <form onSubmit={handlePay}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={payBill.isPending} className="bg-[#1A5C38] hover:bg-[#155A2F]">
