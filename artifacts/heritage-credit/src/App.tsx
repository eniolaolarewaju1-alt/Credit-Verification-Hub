    ...
    <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full p-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onDismiss}
            className="flex-1 bg-[#1A5C38] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#155A2F] transition-colors"
          >
            Stay Signed In
          </button>
        </div>
...
function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#0F3522] flex items-center justify-center">
