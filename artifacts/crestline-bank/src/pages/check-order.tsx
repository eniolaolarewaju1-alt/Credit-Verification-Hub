  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Order personal or business checks for your Crestline Bank checking account.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <form onSubmit={handleSubmit} className="lg:col-span-2 space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#1A5C38] hover:bg-[#155E36] text-white font-semibold py-3 rounded-xl text-sm transition-colors"
          >
            Place Order — ${total}
          </button>
        </form>
