...
const ATMs = [
  ...
  {
    id: 2,
    name: "Crestline Bank — Buckhead",
    address: "1820 Sam Rittenberg Blvd",
    city: "Atlanta, GA 29407",
    distance: "4.1 mi",
    hours: "Open 24/7",
  ...
  {
    id: 6,
    name: "Crestline Bank — Perimeter",
    address: "4900 Centre Pointe Dr",
    city: "North Atlanta, GA 29418",
    distance: "9.3 mi",
    hours: "Open 24/7",
    features: ["Surcharge-Free", "Deposits", "Drive-Thru"],
    type: "branch",
