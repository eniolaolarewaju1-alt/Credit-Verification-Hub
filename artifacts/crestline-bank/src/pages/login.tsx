...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#071C11] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button type="submit" disabled={isLoading} data-testid="button-sign-in"
                  className="w-full bg-[#1A5C38] hover:bg-[#155E36] text-white font-semibold py-2.5 rounded-lg text-sm transition-colors mt-2 disabled:opacity-60 disabled:cursor-not-allowed">
            ...
            <>
              ...
              <form onSubmit={handleOtpVerify} className="space-y-4">
                ...
                <button type="submit" disabled={otpLoading || otp.length < 6}
                  className="w-full bg-[#1A5C38] hover:bg-[#155E36] text-white font-semibold py-2.5 rounded-lg text-sm transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
        ...
        <p className="text-center text-white/40 text-xs mt-6">
          Member FDIC &nbsp;|&nbsp; Equal Housing Lender &nbsp;|&nbsp; &copy; {new Date().getFullYear()} Crestline Bank
        </p>
      </div>
    </div>
  );
