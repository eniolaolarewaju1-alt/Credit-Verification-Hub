  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400 mt-1">Manage your Crestline Bank credit and debit cards.</p>
      </div>
            ...
            return (
              <div key={card.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden" data-testid={`card-item-${card.id}`}>
                ...
                <div className={`m-5 h-48 rounded-xl p-5 relative overflow-hidden text-white flex flex-col justify-between ${isFrozen
                  ...
                  : isCredit
                    ? "bg-gradient-to-br from-[#1A5C38] to-[#0a5a9c]"
                    : "bg-gradient-to-br from-[#0D3460] to-[#071C11]"
                  } shadow-lg`}>
                  ...
                  <div className="relative z-10 flex justify-between items-start">
                    <div className="font-bold text-base text-white/90 tracking-wide">Crestline</div>
