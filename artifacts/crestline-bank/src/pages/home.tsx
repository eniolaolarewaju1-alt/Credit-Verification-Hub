...
const ROUTING_NUMBER = "061000104";
      ...
      >
        ...
        <div
          className={`absolute inset-0 rounded-2xl p-5 flex flex-col justify-between ${
            isChecking
              ? "bg-[#155E36] text-white shadow-lg shadow-[#1A5C38]/30"
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="flex items-center gap-1.5 bg-[#1A5C38] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#155E36] transition-colors shadow-sm"
          >
