    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <Button onClick={onClose} className="w-full bg-[#1A5C38] hover:bg-[#155E36]">
            Close
          </Button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="flex gap-3">
            <Button
              className="flex-1 bg-[#1A5C38] hover:bg-[#155E36]"
              onClick={() => {
                onClose();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="shadow-sm bg-white">
            <CardHeader>
              ...
              <CardDescription>Transfer instantly between your Crestline Bank accounts. Funds will be automatically reversed within 5 minutes (demo portal).</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleInternalTransfer} className="space-y-5">
                ...
                <Button type="submit" className="w-full bg-[#1A5C38] hover:bg-[#155E36]" disabled={!fromAccount || !toAccount || !amount || createTransfer.isPending}>
            ...
            <Card className="shadow-sm bg-white">
              ...
              <CardContent>
                <form onSubmit={handleDirectExternalTransfer} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-[#1A5C38] hover:bg-[#155E36]"
                    disabled={
                      !extFromAccount ||
                      directRouting.length !== 9 ||
                      !routingLookup?.valid ||
        ...
        <div className="space-y-4">
          <Card className="shadow-sm bg-white">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              ...
              {!showAddPayee && (
                <Button onClick={() => setShowAddPayee(true)} size="sm" className="bg-[#1A5C38] hover:bg-[#155E36]">
                ...
                {verifyResult?.verified && (
                  <form onSubmit={handleSavePayee} className="space-y-4 border-t pt-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button type="submit" className="bg-[#1A5C38] hover:bg-[#155E36]" disabled={!recipientName || !payeeNickname || createPayee.isPending}>
                    ...
                    <div key={p.id} className="flex items-center gap-3 p-4 rounded-lg border border-gray-100 bg-gray-50">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <Button
                          ...
                          className="bg-[#1A5C38] hover:bg-[#155E36] text-xs h-8"
                        >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card className="shadow-sm bg-white">
        <CardHeader>
          ...
          <CardDescription>Set up automatic transfers between your Crestline Bank accounts.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <button type="submit" disabled={submitting}
              className="w-full bg-[#1A5C38] hover:bg-[#155E36] text-white font-semibold py-2.5 rounded-xl text-sm transition-colors disabled:opacity-60">
