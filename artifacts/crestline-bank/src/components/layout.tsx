  ...
  return (
    <>
      ...
      <div className="px-5 py-5 flex items-center gap-2.5 border-b border-sidebar-border">
        ...
        <div>
          <div className="font-bold text-base text-white leading-none">Crestline</div>
    ...
    <div className="flex min-h-[100dvh] w-full">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-base font-semibold text-[#1A5C38] truncate">
                {PAGE_TITLES[location] ?? "Crestline Bank"}
              </h2>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-80 overflow-hidden">
            <div className="bg-[#1A5C38] px-4 py-3 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm font-semibold">Crestline Bank Support</span>
              </div>
        ...
        <button
          ...
          className="w-14 h-14 rounded-full bg-[#1A5C38] hover:bg-[#155E36] text-white shadow-lg hover:shadow-xl transition-all flex items-center justify-center"
